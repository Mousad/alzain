      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-gray-600 max-w-3xl mx-auto">
            نحن <span className="font-bold text-xl ">  تيم 
         <span className="text-xs text-[#E53935]"> الزين </span></span> مطعم متخصص في تقديم أفضل أنواع البيتزا والفطاير باستخدام مكونات طازجة يوميًا 
          </p>
        </div>
        ...
        <div className="mb-16">
          <img
            src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRcG-rg44yc5VtE1Z0nfrkZJNlP4RoiTz1vH-AldTUirU2n2sFP"
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <img
              src="https://i.pinimg.com/736x/0c/c7/3e/0cc73e0ce477bc4d3d1bc424764fbe41.jpg"
              alt="مطبخنا"
              className="w-full h-64 object-cover rounded-2xl shadow-lg"
            />
            <img
              src="https://i.pinimg.com/736x/6d/fc/12/6dfc1235a554c8be1d9e37a2cc1afc21.jpg"
              alt="الفرن"
              className="w-full h-64 object-cover rounded-2xl shadow-lg"
            />
            <img
              src="https://i.pinimg.com/1200x/1f/d4/f6/1fd4f600ef441ae24a410256784fc288.jpg"
              alt="التوصيل"
              className="w-full h-64 object-cover rounded-2xl shadow-lg"
            />
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-12 text-center max-w-3xl mx-auto">
          ...
          <div className="space-y-3 text-lg">
            <p>📞 01012061304 </p>
            <p>📍 : مصر-  المهندسين 193 شارع السودان</p>
