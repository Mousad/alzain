    ...
    <footer className="bg-gray-900 text-white mt-2">
      <div className="container mx-auto px-4 py-2">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About */}
          <div className="">
            <h3 className="text-xl  text-center justify-center mb-4 text-[#FFC107]">  تيم 
         <span className="text-xs text-[#E53935]"> الزين </span></h3>
        ...
        <div className="border-t border-gray-700 mt-12 pt-5 text-center text-gray-400">
          <p>© 2026    تيم 
         <span className="text-xs text-[#E53935]"> الزين </span>  . جميع الحقوق محفوظة</p>
        </div>
      </div>
    </footer>
  );
